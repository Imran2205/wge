...
class TensorDebugger(object):
    ...
    def debug(self, sess, fetches, feed_dict):
        ...
        for name, cand_nodes in list(self.name_to_nodes.items()):
        ...
        for name, placeholders in list(self.name_to_placeholders.items()):
        ...
        bp_results = {unwrap(k): unwrap(v) for k, v in list(bp_results.items())}
